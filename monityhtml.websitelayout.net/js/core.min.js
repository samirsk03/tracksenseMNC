! function(o) {
    ...
    o.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            ...
            return o(this).find(".navbar-toggler").on("click", function() {
            ...
            })) : e.addClass("dropdown"), !0 === i.sticky && e.css("position", "fixed"), t(), o(window).on("resize", t)
        })
...
function(o) {
    ...
    e.Defaults = {
        ...
        function p(t) {
            ...
            t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function() {
                ...
                f(o, c)
            }, d)) : t.parents(".cd-headline").hasClass("letters") ? (i = t.children("i").length >= o.children("i").length, function t(e, i, o, n) {
            ...
            }(t.find("i").eq(0), t, i, n), m(o.find("i").eq(0), o, i, n)) : t.parents(".cd-headline").hasClass("clip") ? t.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, h, function() {
                y(t, o), f(o)
    ...
    function() {
        var c, o, u, d, t, r, p, E, n, f, l, s, h, i, m, A, a, e, g, y = [].slice;
        ...
        function v(t) {
            ...
            null == (t = this.options).duration && (t.duration = c), this.MAX_VALUES = this.options.duration / d / u | 0, this.resetFormat(), this.value = this.cleanValue(null != (t = this.options.value) ? t : ""), this.renderInside(), this.render();
            try {
        ...
        o = /^\(?([^)]*)\)?(?:(.)(d+))?$/, c = 2e3, u = 2, d = 1e3 / 30, g = document.createElement("div").style, p = null != g.transition || null != g.webkitTransition || null != g.mozTransition || null != g.oTransition, h = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, t = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, n = function(t) {
            ...
            var e, i, o, n, s, r, a, l, c, u, d, h;
            for (null == t && (t = this.value), this.stopWatchingMutations(), this.resetFormat(), this.inside.innerHTML = "", r = this.options.theme, s = [], l = 0, u = (e = this.el.className.split(" ")).length; l < u; l++)(i = e[l]).length && ((n = /^odometer-theme-(.+)$/.exec(i)) ? r = n[1] : /^odometer(-|$)/.test(i) || s.push(i));
            for (s.push("odometer"), p || s.push("odometer-no-transitions"), s.push(r ? "odometer-theme-" + r : "odometer-auto-theme"), this.el.className = s.join(" "), this.ribbons = {}, this.digits = [], a = !this.format.precision || !f(t) || !1, c = 0, d = (h = t.toString().split("").reverse()).length; c < d; c++) "." === (o = h[c]) && (a = !0), this.addDigit(o, a);
            ...
            var e, i, o, n, s, r, a, l, c, u, d, h, p, f, m, g, y, v, b, w, x, _, C, $, T, S = this.value,
                k = this.getFractionalDigitCount(S, t);
            if (k && (t *= Math.pow(10, k), S *= Math.pow(10, k)), o = t - S) {
                for (this.bindTransitionEnd(), n = this.getDigitCount(S, t), s = [], u = y = e = 0; 0 <= n ? y < n : n < y; u = 0 <= n ? ++y : --y) {
                    if (m = A(S / Math.pow(10, n - u - 1)), r = (a = A(t / Math.pow(10, n - u - 1))) - m, Math.abs(r) > this.MAX_VALUES) {
                        for (c = [], d = r / (this.MAX_VALUES + this.MAX_VALUES * e * .5), i = m; 0 < r && i < a || r < 0 && a < i;) c.push(Math.round(i)), i += d;
                    ...
                    for (u = v = 0, w = c.length; v < w; u = ++v) l = c[u], c[u] = Math.abs(l % 10);
                    s.push(c)
                }
                for (this.resetDigits(), u = b = 0, x = ($ = s.reverse()).length; b < x; u = ++b)
                    for (c = $[u], this.digits[u] || this.addDigit(" ", k <= u), null == (g = this.ribbons)[u] && (g[u] = this.digits[u].querySelector(".odometer-ribbon-inner")), this.ribbons[u].innerHTML = "", o < 0 && (c = c.reverse()), h = C = 0, _ = c.length; C < _; h = ++C) l = c[h], (f = document.createElement("div")).className = "odometer-value", f.innerHTML = l, this.ribbons[u].appendChild(f), h === c.length - 1 && E(f, "odometer-last-value"), 0 === h && E(f, "odometer-first-value");
    ...
    function(c) {
        ...
        c.fn.countdown = function(t, s) {
            ...
            function e() {
                ...
                i -= 60 * n * 60, i -= 60 * (e = Math.floor(i / 60)), 1 == o ? r.find(".timeRefDays").text("day") : r.find(".timeRefDays").text("days"), 1 == n ? r.find(".timeRefHours").text("hour") : r.find(".timeRefHours").text("hours"), 1 == e ? r.find(".timeRefMinutes").text("minute") : r.find(".timeRefMinutes").text("minutes"), 1 == i ? r.find(".timeRefSeconds").text("second") : r.find(".timeRefSeconds").text("seconds"), "on" == a.format && (o = 2 <= String(o).length ? o : "0" + o, n = 2 <= String(n).length ? n : "0" + n, e = 2 <= String(e).length ? e : "0" + e, i = 2 <= String(i).length ? i : "0" + i), isNaN(t) ? (alert("Invalid date. Here's an example: 12 Tuesday 2012 17:30:00"), clearInterval(l)) : (r.find(".days").text(o), r.find(".hours").text(n), r.find(".minutes").text(e), r.find(".seconds").text(i))
            }
            t && c.extend(a, t), e();
            ...
            proto: {
                ...
                getInline: function(t, e) {
                    if (C(), t.src) {
                        var i, o = f.st.inline,
                            n = c(t.src);
                        return n.length ? ((i = n[0].parentNode) && i.tagName && (T || ($ = o.hiddenClass, T = d($), $ = "mfp-" + $), S = n.after(T).detach().removeClass($)), f.updateStatus("ready")) : (f.updateStatus("error", o.tNotFound), n = c("<div>")), t.inlineElement = n
                    }
        ...
        ! function() {
            ...
            t.prototype.init = function() {
                ...
                if (i.find(".lg-object").hasClass("lg-has-poster") && i.find(".lg-object").is(":visible"))
                    ...
                    } else i.addClass("lg-video-playing lg-has-video"), n = function(t, e) {
                    ...
                    }, o.core.s.dynamic ? n(o.core.s.dynamicEl[o.core.index].src, o.core.s.dynamicEl[o.core.index].html) : n(o.core.$items.eq(o.core.index).attr("href") || o.core.$items.eq(o.core.index).attr("data-src"), o.core.$items.eq(o.core.index).attr("data-html")), n = i.find(".lg-object"), i.find(".lg-video").append(n), i.find(".lg-video-object").hasClass("lg-html5") || (i.removeClass("lg-complete"), i.find(".lg-video-object").on("load.lg error.lg", function() {
    ...
    function(t, e) {
        ...
        ! function() {
            ...
            t.prototype.init = function() {
                ...
                if (!n) return 1;
                var s, i = 1;
                return "X" === e ? (s = Math.sign(parseFloat(n[0])), 0 === t || 180 === t ? i = 1 : 90 === t && (i = -90 === o && 1 === s || 90 === o && -1 === s ? -1 : 1)) : (s = Math.sign(parseFloat(n[3])), 0 === t || 180 === t ? i = 1 : 90 === t && (t = parseFloat(n[1]), n = parseFloat(n[2]), i = Math.sign(t * n * o * s))), i *= s
    ...
    function() {
        ...
        function x(c, u, d) {
            var t, e, i, h, p;
            t = 0 < (t = u) ? 1 : -1, e = 0 < (e = d) ? 1 : -1, o.x === t && o.y === e || (o.x = t, o.y = e, v = [], w = 0), 1 != f.accelerationMax && ((e = Date.now() - w) < f.accelerationDelta && (1 < (i = (1 + 50 / e) / 2) && (i = Math.min(i, f.accelerationMax), u *= i, d *= i)), w = Date.now()), v.push({
                x: u,
                y: d,
                lastX: u < 0 ? .99 : -.99,
                lastY: d < 0 ? .99 : -.99,
                ...
                h ? window.scrollBy(i, o) : (i && (c.scrollLeft += i), o && (c.scrollTop += o)), u || d || (v = []), v.length ? V(p, c, 1e3 / f.frameRate + 1) : (b = !1, null != c.$scrollBehavior && (c.style.scrollBehavior = c.$scrollBehavior, c.$scrollBehavior = null))
            }, V(p, c, 0), b = !0)
        }
        ...
        function t(t) {
            ...
            return e ? !! function(t) {
                ...
                var e = 120 < t && H(t),
                    e = !H(120) && !H(100) && !e;
                return t < 50 || e
            }(o) || (1.2 < Math.abs(i) && (i *= f.stepSize / 120), 1.2 < Math.abs(o) && (o *= f.stepSize / 120), x(e, i, o), t.preventDefault(), void A()) : !u || !G || (Object.defineProperty(t, "target", {
        ...
        function _(t) {
            ...
            var n = 0,
                s = 0,
                r = z(c);
            if (!r) return !u || !G || parent.keydown(t);
        ...
        function z(t) {
            ...
            do {
                ...
                if (e.push(t), o === t.scrollHeight) {
                    n = I(h) && I(i) || M(h);
                    if (u && O(h) || !u && n) return P(e, B())
                } else if (O(t) && M(t)) return P(e, t)
